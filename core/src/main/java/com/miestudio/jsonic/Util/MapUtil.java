...
public class MapUtil {
    /**
     * Encuentra un punto de spawn específico para un tipo de personaje en una capa dada del mapa.
     ...
     * @param target El tipo de entidad cuyo punto de spawn se está buscando.
     * @return La posición (Vector2) del punto de spawn del personaje, o null si no se encuentra.
     */
    ...
    /**
     * Encuentra todos los puntos de spawn para un tipo de entidad específico en una capa dada del mapa.
     * @param map El mapa de tiles.
     * @param layerName El nombre de la capa del mapa donde buscar los puntos de spawn.
     * @param target El tipo de entidad cuyos puntos de spawn se están buscando.
